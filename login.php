						...
						<form action="" method="post" >
							<div class="login-form-elements">
								...
								<div class="col-xs-10 form-group login-form-div">
									<input class="form-control" id="loginUser" name="userName" placeholder="Email" onkeypress="setDiv('loginError', '');setDiv('userError', '');" autocomplete="off" onblur="this.value=this.value.trim();validEmailaddress('loginUser','userError','Please enter your Email address','Please enter a valid Email address')" type="text" required>
								...
								<div class="col-xs-10 form-group form-group-login">
									<input class="form-control" id="loginPass" name="password" placeholder="Password" maxlength="15" onblur="validatePassword()" onkeypress="setDiv('loginError', '');setDiv('passwordError', '');" type="password" required>
									<div class="has-error" id="passwordError">   &nbsp;</div>
								</div>
								
								<div class="col-xs-12 no-padding" style="padding:0;">
									<div class="form-group login-btn">
										<input value="Submit" class="btn btn-blue form-control pull-right" name="loginSubmit" type="submit">
									</div>
								</div>
							</div>
						</form>
