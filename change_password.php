						...
						<form action="" method="post">
							<div class="login-form-elements">
								...
								<div class="col-xs-10 form-group login-form-div">
									<input class="form-control" id="oldpwd" name="oldpassword"
								...
								<div class="col-xs-10 form-group form-group-login">
									<input class="form-control" id="newpwd" name="newpassword"
										placeholder="Enter New Password" maxlength="15" onblur="validatePassword()"
								...
								<div class="col-xs-10 form-group form-group-login">
									<input class="form-control" id="confirmpwd" name="confirmpassword"
										placeholder="Confirm your password" maxlength="15" onblur="validatePassword()"
										onkeypress="setDiv('loginError', '');setDiv('passwordError', '');" type="password">
									<div class="has-error" id="passwordError" required> &nbsp;</div>
								</div>
								<div class="col-xs-12 no-padding" style="padding:0;">
									<div class="form-group login-btn">
										<input value="Submit" class="btn btn-blue form-control pull-right" name="submit"
											type="submit">
									</div>
								</div>
							</div>
