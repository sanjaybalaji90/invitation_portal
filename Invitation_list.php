<?php 
	...
	$sqlQuery = " SELECT DISTINCT name,date,Event_Id FROM invitations_response_table ORDER BY Event_Id DESC ";
                        ...
                        <div class='col-sm-12'>
                           ...
                           <form id='eventDetails' action='' method='post'>
                              <div class='col-sm-12 widgetDescriptionForm'>
                                 <div class='row'>
								 <h4 class='header_title'>Invitation Responses</h4>
                                    <div class='widgetDescriptionRow widgetDescriptionRow_invlist clearfix'>
									
									  <fieldset class='col-sm-3 form-group'>
									  <label><span class='requiredFiled'></span>Invitaion List</label>
										<form>
											<?php
												echo "<select id='sel2'  onchange='showUser(this.value)'>";
													...
													echo '<option value="'.$Event_Id.'">'.$invitation_name.'</option>';
												}
												echo "</select>";
											?>
										</form>
