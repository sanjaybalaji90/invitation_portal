							...
							<!-- <h4>Invitaion Portal <h4> -->
                             <div class='col-sm-12 widgetDescriptionForm'>
                                <div class='row'>
									...
									<a href="Invitaion_portal_admin_temp.php"><h4 class='template_heading'>Select Template View</h4></a>
                                    <div class='widgetDescriptionRow clearfix'>								
									   <fieldset class='col-sm-4 form-group'>
                                          ...
                                          <input id='invitaionName' name='invitaionName' class='form-control' onblur='this.value=this.value.trim();' type='text' value='' maxlength='30' required >
									   ...
									   <fieldset class='col-sm-4 form-group'>
                                          ...
                                          <input id='invitaionFrom' name='invitaionForm' class='form-control' onblur='this.value=this.value.trim();' type='text' value='' maxlength='30' required >
                                          <div class='discriptionErrorMsg'>
                                             <span id='eventNameDiv' class='red-color-error'>&nbsp;</span>
                                          </div>
                                       </fieldset>
									   <fieldset class='col-sm-4 form-group'>
											<label><span class='requiredFiled'>*</span>Event Date & Time</label>
											 <div id='datetimepicker1' class='input-append date'>
												<input id='eventDate' name='eventDate' data-format='dd/MM/yyyy hh:mm:ss' type='text' required readonly ></input>
												<span class='add-on'>
										...
										<fieldset class='col-sm-4 form-group'>
                                          ...
                                          <input id='eventPlace' name='eventPlace' class='form-control' onblur='this.value=this.value.trim();' type='text' value='' maxlength='30' required >
                                          <div class='discriptionErrorMsg'>
                                             <span id='eventNameDiv' class='red-color-error'>&nbsp;</span>
                                          </div>
                                       </fieldset>
